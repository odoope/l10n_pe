...
class ResPartner(models.Model):
    ...
    def get_data_ruc(self):
        ...
        self.registration_name =result['registration_name']
    ...
    def sunat_connection(self,ruc):
        ...
        try:
            ...
            .replace('\n', '').strip()
            data['registration_name'] = (table_info[sunat_cons.registration_name.value].find_all("td"))[1].contents[0].replace('-','').strip()    
